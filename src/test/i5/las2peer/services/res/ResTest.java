 ...
 * 172 - Test Class
 *
 * This class provides a basic testing framework for the microservice 172. It was
...
public class ResTest {
  ...
  /**
   * 
   * Test for the testm method.
   * 
   */
  @Test
  public void testtestm() {
    MiniClient c = new MiniClient();
    c.setAddressPort(HTTP_ADDRESS, HTTP_PORT);
    try {

      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/testm", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testtestm': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
